...
extension AnalogClockView {
    ...
    func addSecondsLayer() {
        let color = #colorLiteral(red: 0.852196157, green: 0.1763460338, blue: 0.4813976884, alpha: 1)
        secondLayer = setUpLayer(backgroundColor: color, anchorPointX: 0.5, anchorPointY: 0, xPosition: layerXPosition, yPosition: layerYPosition, frame: CGRect(x: 0, y: 0, width: HandWidth.second, height: (self.frame.width/2)-(self.frame.width * 0.1)), contents: nil)
